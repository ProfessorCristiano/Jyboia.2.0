...
Suporta termos com e sem acentuação para máxima flexibilidade.
"""

from typing import Dict, Set

# Mapeamento de palavras-chave simples (1 token -> 1 token)
...
# Expressões compostas (múltiplos tokens consecutivos)
...
# Funções e tipos embutidos traduzidos
...
# Conjunto de todas as palavras reservadas do Jybóia para highlight
