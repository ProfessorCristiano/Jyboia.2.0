"""
Mapeamento de código fonte (SourceMap) e remapeamento de erros/tracebacks para o Thonny.
"""
...
ERROS_TRADUZIDOS: Dict[str, Tuple[str, str]] = {
    "SyntaxError": (
        "Erro de Sintaxe",
        "A estrutura do comando não foi compreendida. Verifique se esqueceu dois-pontos (:), parênteses ou aspas.",
    ),
    "IndentationError": (
        "Erro de Indentação",
