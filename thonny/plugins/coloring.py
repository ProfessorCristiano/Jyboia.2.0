            ...
            for match in self.uniline_regex.finditer(chars):
                for token_type, token_text in match.groupdict().items():
                    if token_text and token_type in self.uniline_tags:
                        ...
                        # Mark also the word following def or class (including Jybóia keywords)
                        if token_text in ("def", "class", "funcao", "função", "defina", "classe"):
                            ...
                            if id_match:
                                ...
                                if token_text in ("def", "funcao", "função", "defina"):
